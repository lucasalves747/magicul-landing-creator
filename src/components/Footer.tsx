          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="#topicos" className="hover:text-primary transition-colors">Tópicos</a></li>
                <li><a href="#palestrantes" className="hover:text-primary transition-colors">Palestrantes</a></li>
                <li><a href="#checkout" className="hover:text-primary transition-colors">Inscreva-se</a></li>
              </ul>
            </div>
